...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Reasonably Useful ",
    Description = "A place to put things that are reasonably useful",
    `Authors@R` = c(
      person("Ali", "Vaughan", email = "alison.vaughan.mailes@gmail.com", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000")))))
# Define License with use_*_license()
usethis::use_mit_license("Ali Vaughan")
```
